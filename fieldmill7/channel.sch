...
F 0 "#PWR054" H 2150 4150 50  0001 C CNN
...
F 1 "10p" H 6560 3870 50  0000 L CNN
...
F 0 "#PWR055" H 6850 2750 50  0001 C CNN
...
F 1 "10p" H 6560 5620 50  0000 L CNN
...
F 0 "#PWR056" H 6850 4500 50  0001 C CNN
...
F 0 "#PWR058" H 6650 4400 50  0001 C CNN
...
F 0 "#PWR059" H 6650 3250 50  0001 C CNN
...
F 0 "#PWR060" H 6650 5000 50  0001 C CNN
...
F 0 "#PWR061" H 2300 4000 50  0001 C CNN
...
F 0 "#PWR062" H 2300 4500 50  0001 C CNN
...
F 0 "#PWR064" H 4950 4300 50  0001 C CNN
...
U 1 1 580621C2
P 3650 4350
AR Path="/57B05F2F/580621C2" Ref="#PWR039"  Part="1" 
AR Path="/57B0A0EC/580621C2" Ref="#PWR052"  Part="1" 
AR Path="/57B0A102/580621C2" Ref="#PWR065"  Part="1" 
...
U 1 1 58062913
P 5150 4350
AR Path="/57B05F2F/58062913" Ref="#PWR040"  Part="1" 
AR Path="/57B0A0EC/58062913" Ref="#PWR053"  Part="1" 
AR Path="/57B0A102/58062913" Ref="#PWR066"  Part="1" 
F 0 "#PWR066" H 5150 4200 50  0001 C CNN
...
10p capacitor serves both to low-pass (1.6 kHz)\nand limit high frequency noise gain
$Comp
L R_Small R35
U 1 1 58085E26
P 6550 5400
