...
#define __INTPTR_T signed short
#define __FC_INTPTR_MIN __FC_SHRT_MIN
#define __FC_INTPTR_MAX __FC_SHRT_MAX

#define __UINTPTR_T unsigned short
#define __FC_UINTPTR_MAX __FC_USHRT_MAX
...
#else
  error "I'm supposed to be called with __FC_MACHDEP_GCC_AVR_16 macro defined"
#endif
#endif
