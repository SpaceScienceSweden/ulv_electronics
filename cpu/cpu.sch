...
U 1 1 57A6D41C
P 9750 3550
F 0 "#PWR06" H 9750 3400 50  0001 C CNN
...
U 1 1 57A7210C
P 7250 4650
F 0 "#PWR011" H 7250 4500 50  0001 C CNN
...
U 1 1 57F3B202
P 1400 4050
F 0 "#PWR013" H 1400 3800 50  0001 C CNN
...
U 1 1 57F3B46F
P 1400 4450
F 0 "#PWR014" H 1400 4200 50  0001 C CNN
...
F 1 "8 MHz" H 3950 2750 50  0000 C CNN
...
U 1 1 57F3D591
P 3500 3000
F 0 "#PWR017" H 3500 2750 50  0001 C CNN
...
U 1 1 57F3D5D1
P 2800 2500
F 0 "U1" H 2995 2615 50  0000 C CNN
F 1 "4050" H 2990 2375 50  0000 C CNN
...
U 1 1 57F3E635
P 3450 2250
F 0 "#PWR018" H 3450 2000 50  0001 C CNN
...
U 1 1 57F5D863
P 5750 1700
F 0 "#PWR019" H 5750 1450 50  0001 C CNN
...
U 1 1 57F5DD88
P 3900 3250
F 0 "C8" H 3910 3320 50  0000 L CNN
F 1 "100n" H 3910 3170 50  0000 L CNN
F 2 "Capacitors_SMD:C_0805" H 3900 3250 50  0001 C CNN
...
U 1 1 57F5DEF6
P 3800 3250
F 0 "#PWR020" H 3800 3000 50  0001 C CNN
...
U 1 1 57F5E2C4
P 3400 3800
F 0 "Y2" H 3400 3900 50  0000 C CNN
F 1 "32768 Hz" H 3400 3700 50  0000 C CNN
...
F 1 "?p" H 3260 3420 50  0000 L CNN
...
U 1 1 57F5E8A5
P 3250 4150
F 0 "C10" H 3260 4220 50  0000 L CNN
F 1 "?p" H 3260 4070 50  0000 L CNN
...
U 1 1 57F5EC0B
P 3150 4150
F 0 "#PWR021" H 3150 3900 50  0001 C CNN
...
U 1 1 57F605CB
P 7800 1300
F 0 "U2" H 7800 2500 50  0000 C CNN
F 1 "MS628128" H 7870 100 50  0000 C CNN
F 2 "SMD_Packages:SOJ-32" H 7800 1300 50  0001 C CNN
F 3 "" H 7800 1300 50  0000 C CNN
	1    7800 1300
	0    -1   -1   0   
$EndComp
Text Notes 7600 800  0    60   ~ 0
TODO: XMEM or not? we seem to have pins  for it
$EndSCHEMATC
